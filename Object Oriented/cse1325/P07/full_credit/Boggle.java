...
public class Boggle {
    ...
    private static void solveRange(int first, int lastPlusOne, int threadNumber) {
        for(int i = first; i <= lastPlusOne-1; i++) {
            ...
            Solver solver = new Solver(bloop, threadNumber, verbosity); 
    ...
    public static void main(String[] args) {
        try {
            ...
            double boardPerThread = numberOfBoards/numThreads;

            for(int i = 0; i < numThreads; i++) {
                final int first = (int)(threadNumber*boardPerThread);
                ...
                if(threadNumber == numThreads -1) {
                    ...
                    lastPlusOne = (int)((threadNumber + 1)*boardPerThread);
                }
